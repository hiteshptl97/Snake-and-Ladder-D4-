...
and it continues unless he reaches to 100 point.*/
    ...
    public class RepeatTillThePlayerReachesTheWinningPosition100 {

        RepeatTillThePlayerReachesTheWinningPosition100 (){  System.out.println("Welcome to Snake and Ladder Simulation \n");}

        public static void main(String[] args) {
            RepeatTillThePlayerReachesTheWinningPosition100 a = new  RepeatTillThePlayerReachesTheWinningPosition100 ();
