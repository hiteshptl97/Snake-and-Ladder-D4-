...
/*This is a Snake and Ladder game simulation program where a single player is playing, and we need to
    check the winner.*/
      ...
      public class PlayTheGameWithTwoPlayer {

          PlayTheGameWithTwoPlayer() {System.out.println("Welcome to Snake and Ladder Simulation \n");}

        public static void main(String[] args) {
            PlayTheGameWithTwoPlayer a = new PlayTheGameWithTwoPlayer();
            String p1 = "Player1";
            String p2 = "Player2";
